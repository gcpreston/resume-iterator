      ...
      it("should create a new conversation and return assistant reply", async () => {
        ...
        expect(mockAgentsCreate).toHaveBeenCalledWith({
          ...
          instructions: expect.stringContaining(
            "You will help the user iterate on a resume"
          ),
          ...
          tools: [
            {
              ...
              function: {
                name: "getResumeText",
                description:
                  "Get the current version of the resume or CV that the user is editing.",
                parameters: {
                  type: "object",
                  properties: {},
                  required: [],
    ...
    describe("Tool Usage Scenarios", () => {
          ...
          outputs: [
            {
              type: "message.output",
              content:
                "Based on your resume, I can see you have strong experience...",
      ...
      it("should handle tool call with empty resume text", async () => {
        ...
        expect(result.reply).toBe(
          "I notice you haven't provided a resume yet..."
        );
      });
...
Skills: JavaScript, TypeScript, React, Node.js`;
    ...
    describe("Error Handling", () => {
      it("should throw error when conversation has no outputs", async () => {
        ...
        await expect(
          getAssistantReply(testApiKey, null, testMessage, testResumeText)
        ).rejects.toThrow();
      });
      ...
      it("should throw error when first output is not a message", async () => {
        ...
        await expect(
          ...
          "Unable to convert message type function.call to reply"
        );
      });
